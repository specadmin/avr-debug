...
#define DHEX(var)  { debug_print_hex(var); }
...
void debug_print_dec(void* data);
void debug_print_dec(char data);
void debug_print_dec(int data);
void debug_print_dec(long data);
void debug_print_dec(unsigned char data);
void debug_print_dec(unsigned int data);
void debug_print_dec(unsigned long data);
void debug_print_hex(void* data);
